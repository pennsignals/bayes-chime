...
python _01_GOF_sims.py -p data/LGH_parameters.csv -t data/LGH_ts.csv -C 8 -f -i 5000 | python _02_munge_chains.py -o '-' -P LGH
python _01_GOF_sims.py -p data/LGH_parameters.csv -t data/LGH_ts.csv -C 8 -bf -i 5000 | python _02_munge_chains.py -o '-' -P LGH
